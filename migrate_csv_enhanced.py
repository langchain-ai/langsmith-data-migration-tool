...
class EnhancedCSVMigrator:
    def __init__(self, api_key: Optional[str] = None, api_url: Optional[str] = None, project_id: Optional[str] = None):
        ...
        if self.project_id:
            ...
            console.print(f"[green]Connected to LangSmith project: {self.project_id}[/green]")
        else:
            self.client = Client(api_key=self.api_key, api_url=self.api_url)
            console.print(f"[green]Connected to LangSmith[/green]")
...
def main():
    ...
    migrator = EnhancedCSVMigrator(api_key=args.api_key, api_url=args.api_url, project_id=args.project_id)
